...
Income-first paper-trading CFO dashboard for a solo business owner to track weekly distributions, simulate monthly withdrawals, monitor principal balance, and flag threshold breaches across two investment sleeves (ARMW/AMDW) targeting SGD 6,094.91/month for 24 months.
